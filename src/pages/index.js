...
const HomePage = () => {
  const slides = [
    { image: "/a2.jpg", title: "중국으로의 여정", subtitle: "문화와 역사가 살아 숨 쉬는 곳" },
{ image: "/a3.jpg", title: "함께하면 쉽게", subtitle: "중국 진출의 꿈 비자익스프레스와 함께하세요."},
{ image: "/a4.jpg",  title: "간편한 비자 절차", subtitle: "빠르고 쉬운 비자 신청으로 여행 준비 완료" }
  ];
      ...
      >
        {slides.map((slide, index) => (
          <SwiperSlide key={index}>
            ...
            <div className="absolute top-1/4 left-40 z-20 text-left">
              {/* 제목 */}
